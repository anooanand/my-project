...
import { ReferralSystem } from './ReferralSystem'; // Import the new component
...
export function PricingPagenew() { // Renamed function
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ReferralSystem /> {/* Added ReferralSystem */}
...
export const PricingPageWithFixedVerification = PricingPagenew; // Export the new function