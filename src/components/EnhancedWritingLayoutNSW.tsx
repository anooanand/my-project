// FIXED: AppContent with proper prompt handling for EnhancedWritingLayoutNSW
// This version adds prompt state and passes it to the writing layout component
