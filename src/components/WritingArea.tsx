...
function WritingArea({
  ...
  // Handle content changes and track typing time + automatic feedback
  const handleContentChange = (newContent: string) => {
    ...
    // AUTOMATIC FEEDBACK LOGIC (MINIMAL ADDITION)
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 leading-relaxed">
                <strong>**Prompt: The Secret Door in the Library**</strong>
              </p>
              <p className="text-gray-600 leading-relaxed mt-2">
                While exploring the dusty old library in your new school, you stumble upon a hidden door behind a bookshelf. The door is slightly ajar, and a strange, warm light spills out. Curiosity gets the better of you, and you push the door open.
              </p>
              <p className="text-gray-600 leading-relaxed mt-2">
                Describe what you find inside. What kind of world lies beyond the door? Who (or what) do you meet there, and how does this adventure change you? Will you choose to stay or return to your own world, and what will you take with you as a reminder of this extraordinary experience?
              </p>
            </div>
          </div>
        </div>
